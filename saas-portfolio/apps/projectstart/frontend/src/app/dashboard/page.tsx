...
import { FolderOpen, Plus, Users, Mail, Phone, Building, Calendar, MoreVertical, Share2, FileText, Settings, LogOut, ChevronRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className="fixed inset-y-0 left-0 w-64 bg-gray-900 flex flex-col">
        ...
        <div className="px-4 py-4 border-t border-gray-800">
          <p className="px-3 text-xs font-medium text-gray-500 uppercase tracking-wider mb-3">ConsultKit Apps</p>
          <div className="space-y-1">
            <a href="#" className="flex items-center justify-between px-3 py-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg text-sm">
              <span>ScopeStack</span>
        ...
        <div className="px-4 py-4 border-t border-gray-800">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">john@agency.com</p>
              <p className="text-xs text-gray-400">Free Plan</p>
            </div>
          </div>
          <div className="mt-2 space-y-1">
            <a href="#" className="flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg text-sm">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded" title="Share with client">
                        <Share2 className="h-5 w-5" />
                      </button>
                      <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded" title="Export PDF">
